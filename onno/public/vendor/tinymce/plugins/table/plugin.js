...
define("tinymce/tableplugin/ResizeBars", [
	...
	return function(editor) {
		...
		function bindBlockerEvents(blocker, dragHandler) {
			editor.dom.on('bind', blocker, 'mouseup', function() {
				drop();
			});

			editor.dom.on('bind', blocker, 'mousemove', function(e) {
			...
			editor.dom.on('bind', blocker, 'mouseout', function() {
		...
		editor.on('init', function() {
			...
			editor.dom.on('bind', getBody(), 'mousedown', mouseDownHandler);
		});
