...
(function() {
  ...
  Morris.Grid = (function(_super) {
    ...
    function Grid(options) {
      ...
      this.el.on('bind', 'mousemove', function(evt) {
      ...
      this.el.on('bind', 'mouseleave', function(evt) {
        if (_this.selectFrom) {
      ...
      this.el.on('bind', 'touchstart touchmove touchend', function(evt) {
        var offset, touch;
        touch = evt.originalEvent.touches[0] || evt.originalEvent.changedTouches[0];
        offset = _this.el.offset();
        return _this.fire('hovermove', touch.pageX - offset.left, touch.pageY - offset.top);
      });
      this.el.on('bind', 'click', function(evt) {
        var offset;
        offset = _this.el.offset();
      ...
      if (this.options.rangeSelect) {
        ...
        this.el.on('bind', 'mousedown', function(evt) {
          var offset;
          offset = _this.el.offset();
          return _this.startRange(evt.pageX - offset.left);
        });
        this.el.on('bind', 'mouseup', function(evt) {
          var offset;
          offset = _this.el.offset();
      ...
      if (this.options.resize) {
        $(window).on('bind', 'resize', function(evt) {
  ...
  Morris.DonutSegment = (function(_super) {
    ...
    DonutSegment.prototype.drawDonutSegment = function(path, fillColor, strokeColor, hoverFunction, clickFunction) {
      return this.raphael.path(path).attr({
        ...
        stroke: strokeColor,
        'stroke-width': 2
      }).on('hover', hoverFunction).on('click', clickFunction);
    };
