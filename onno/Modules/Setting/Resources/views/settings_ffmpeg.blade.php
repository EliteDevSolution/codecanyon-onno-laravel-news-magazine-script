                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="recaptcha_settings" role="tabpanel">
                                        {!!  Form::open(['route' => 'update-settings', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'update-settings']) !!}
                                         ...
                                         <div class="col-sm-12">
                                            <div class="m-b-20">
                                                <span class=""><strong> {{ __('ffmpeg_description') }}</strong> </span>
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="ffmpeg_status" id="visibility_show"
                                                           value="1"
                                                           {{ settingHelper('ffmpeg_status') == 1? 'checked':"" }} class="custom-control-input">
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="ffmpeg_status" id="visibility_hide"
                                                           value="0"
                                                           class="custom-control-input" {{ settingHelper('ffmpeg_status') == 0? 'checked':"" }}>
