...
{!!  Form::open(['route' => ['send-replay-email',$message->id], 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}

    <div class="modal-body">

        <div class="col-sm-12">
            <div class="row">
            <label class="col-form-label col-md-12"><i class="fas fa-reply"></i> <b>{{ $message->name }}</b> ({{ $message->email }})</label>
        </div>
