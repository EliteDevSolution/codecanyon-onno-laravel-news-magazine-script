                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="meta_title" class="form-control" value="{{ old('meta_title') }}"
                                               name="meta_title">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {{-- <input id="post_tags" name="tegs" type="text" value="{{ old('tags') }}" class="form-control"> --}}
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post_desc">
                                            <b>{{ __('description') }}</b> ({{ __('meta_tag') }})]
                                        </label>
