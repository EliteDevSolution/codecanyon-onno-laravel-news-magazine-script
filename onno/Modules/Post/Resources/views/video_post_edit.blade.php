                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $post->meta_title }}" id="meta_title"
                                               name="meta_title">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="add-video-tab">
                                    <nav>
                                        <div class="nav nav-tabs m-b-20" id="nav-tab" role="tablist">
                                            <a class="nav-item nav-link @if($post->video_id != null) active @endif"
                                               id="upload-video-file" data-toggle="tab" href="#upload-video"
                                               role="tab">{{ __('upload_video') }}</a>
                                            <a class="nav-item nav-link @if($post->video_id == null) active @endif"
                                               id="video-link" data-toggle="tab" href="#video_by_link"
                                               role="tab">{{ __('remove_video') }}</a>
                                        </div>
                                    </nav>

                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade @if($post->video_id != null) show active @endif"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="video_id" value="{{ $post->video_id }}"
                                                               name="video_id" type="hidden" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <div class="form-group text-center">
                                                            @if(isFileExist($post->video, @$post->video->video_thumbnail))
                                                                <img
                                                                    src="{{basePath($post->video)}}/{{ $post->video->video_thumbnail }} "
                                                                    id="video_thumb" width="200" height="200"
                                                                    alt="image" class="img-responsive img-thumbnail">
                                                            @else
                                                                <img id="video_thumb"
                                                                     src="{{static_asset('default-image/default-video-100x100.png') }} "
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="video_url_type" name="video_url_type"
                                                            ...
                                                            <option @if($post->video_url_type=='mp4_url') selected
                                                                    @endif value="mp4_url">MP4 url
                                                            </option>
                                                            <option @if($post->video_url_type=='youtube_url') selected
                                                                    @endif value="youtube_url">Youtube url
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="video_url" value="{{ $post->video_url }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="video_thumbnail_id" value="{{ $post->video_thumbnail_id }}"
                                           name="video_thumbnail_id" type="hidden" class="form-control">
                                </div>
                                <div class="form-group">
                                    <div class="form-group text-center">
                                        {{-- <img src="{{static_asset('default-image/default.jpg') }} " id="video_thumb_preview"  width="200" height="200" alt="image" class="img-responsive img-thumbnail"> --}}
                                        @if($post->post_type=='video')
                                            @if(isFileExist(@$post->videoThumbnail, @$post->videoThumbnail->thumbnail))
                                                <img src=" {{basePath($post->videoThumbnail)}}/{{ $post->videoThumbnail->thumbnail }}"
                                                     id="video_thumb_preview"  width="200" height="200"alt="{!! $post->title !!}" class="img-responsive img-thumbnail">
                                            @else
