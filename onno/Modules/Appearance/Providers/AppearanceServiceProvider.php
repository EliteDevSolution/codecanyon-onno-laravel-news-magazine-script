...
class AppearanceServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('appearance.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'appearance'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/appearance');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/appearance';
    ...
    {
        $langPath = resource_path('lang/modules/appearance');
