...
@section('content')
    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            {!!  Form::open(['route'=>['update-social', $socialMedia->id],'method' => 'put', 'enctype'=>'multipart/form-data']) !!}
                    ...
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="name" value="{{ $socialMedia->name }}" name="name" type="text"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="url" name="url" value="{{ $socialMedia->url }}" type="text"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="page-title" value="{{ $socialMedia->icon }}" name="icon" type="text"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="page-title" value="{{ $socialMedia->icon_bg_color }}" name="icon_bg_color"
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="page-title" value="{{ $socialMedia->text_bg_color }}" name="text_bg_color"
                                       type="color" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="row p-l-15">
                            ...
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="status" id="status_yes" value="1"
                                           {{$socialMedia->status == 1?'checked':''}} class="custom-control-input">
                            ...
                            <div class="col-3 col-md-2">
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="status" id="status_no" value="0"
                                           {{$socialMedia->status == 0?'checked':''}}  class="custom-control-input">
                            ...
                            <div class="col-12">
                                <div class="form-group form-float form-group-sm">
                                    <button type="submit" class="btn btn-primary float-right m-t-20"><i
                                            class="mdi mdi-plus"></i> {{ __('update_social') }}</button>
                                </div>
                            </div>
                        </div>
