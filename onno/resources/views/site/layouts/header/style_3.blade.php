                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        @foreach($mainMenu->children as $child)
                                                            <li class="nav-item">
                                                                <a class="nav-link {{$mainMenu->children[0]->id == $child->id? 'active':''}}" id="{{$child->category->slug}}-tab" data-toggle="tab" href="#{{$child->category->slug}}" role="tab" aria-controls="{{$child->label}}" aria-selected="{{$mainMenu->children[0]->id == $child->id? 'true':'false'}}">{{$child->label}}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </div>
